        ...
        <br />
                <div class="responsive_menu">
                    <ul>
                                ...
                                <li><asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/AdminAlbums.aspx">Edit albums</asp:HyperLink></li>
                        ...
                        <div class="col-md-12 main_menu">
                            <ul>
                               <!-- <li><a class="show-1 templatemo_home" href="#">Albums</a></li> 
                                ...
                                <li><asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Default.aspx">Albums</asp:HyperLink></li>
                                <li><asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="~/AdminAlbums.aspx">Edit albums</asp:HyperLink></li>
                                <li><asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/AdminStickers.aspx">Edit stickers</asp:HyperLink></li>
                                <li><asp:HyperLink ID="HyperLink5" runat="server" NavigateUrl="~/AdminUsers.aspx">Edit users</asp:HyperLink></li>
                            </ul>
                        </div>
                        <!-- /.col-md-12 -->
                    </div>
