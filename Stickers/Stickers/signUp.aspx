                ...
                <div class="col-md-12 text-center">
                    <div class="tableSignUp">
                        ...
                        <table align="center">
                            ...
                            <tr class="row">
                                <td>
                                    <asp:Label ID="Label4" runat="server" Text="Date of birth:" Font-Bold="True" ForeColor="White"
                                        Font-Underline="True"></asp:Label>
                                </td>
                            </tr>
                            <tr class="row">
                                <td>
                                    <asp:DropDownList CssClass="ddlClass" ID="ddlDay" runat="server" ValidationGroup="dateGroup">
                                    </asp:DropDownList>
                            ...
                            <tr class="row">
                                <td>
                                    <asp:TextBox ID="tbPassword" placeholder="Password" runat="server" TextMode="Password"
                                        class="signUpTextBoxes"></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="row">
                                <td>
                            ...
                            <tr class="row">
                                <td>
                                    <asp:Button CssClass="button" ID="btnSubmit" runat="server" Text="SUBMIT" BackColor="#B00B02"
                                        ForeColor="White" Font-Bold="True" OnClick="btnSubmit_Click" />
                                </td>
                            </tr>
                        </table>
                        <br />
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbFirstName"
                         ErrorMessage="Enter name!" ForeColor="Red" Display="None"></asp:RequiredFieldValidator><br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="tbLastName"
                         ErrorMessage="Enter surname!" ForeColor="Red" Display="None"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlDay"
                         ErrorMessage="Enter date!" ForeColor="Red" ValidationGroup="dateGroup" Display="None"></asp:RequiredFieldValidator><br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="tbPassword"
                         ErrorMessage="Enter password!" ForeColor="Red"  Display="None"></asp:RequiredFieldValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="tbPasswordConfirm"
                          Display="None" ErrorMessage="Re-enter password!" ForeColor="Red"></asp:RequiredFieldValidator><br />
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="tbLocation"
                          Display="None" ErrorMessage="Enter location!" ForeColor="Red"></asp:RequiredFieldValidator><br />
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="tbPassword"
                        ControlToValidate="tbPasswordConfirm"  Display="None" ErrorMessage="Enter the same password!"
                        ForeColor="Red"></asp:CompareValidator>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="tbEmail"
                         Display="None" ErrorMessage="Enter e-mail!" ForeColor="Red"></asp:RequiredFieldValidator><br />
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Email Address in invalid format!"
                        Display="None" ControlToValidate="tbEmail" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator><br />
                </div>
                <!-- /.col-md-12 -->
            </div>
            <!-- /.row -->
